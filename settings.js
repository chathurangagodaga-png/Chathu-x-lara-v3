...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "nVRxTZgD#RaMt839sntgHRA940pLPu6eASFeVJs3HSNV-XAUnNeM", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94705762692",
DEV: process.env.DEV || "94705762692",
